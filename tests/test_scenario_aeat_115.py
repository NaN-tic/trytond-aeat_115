...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        # Activate modules
        activate_modules(['aeat_115', 'account_es', 'account_invoice'])
        ...
        invoice.click('post')
        self.assertEqual(invoice.total_amount, Decimal('714.00'))
        Invoice = Model.get('account.invoice')
        invoice = Invoice()
        invoice.type = 'in'
        ...
        invoice.click('post')
        self.assertEqual(invoice.total_amount, Decimal('510.00'))
        ...
        self.assertEqual(report.parties, 2)
        self.assertEqual(report.withholdings_payments_amount, Decimal('228.00'))
